...
from utilsTM import calculoMetricas
...
print("Dados carregados e estruturados.")
...
print("Alvo real ('Target_Real') criado.")



print("Carregando o modelo de PLN...")
...
print("Previsões da LLM geradas com base no sentimento diário.")
...
calculoMetricas(y_real, y_previsto_pela_llm)
